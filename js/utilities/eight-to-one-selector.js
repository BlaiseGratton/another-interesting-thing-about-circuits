...
export class EightToOneSelector extends ComponentContainer {
  constructor() {
    super()
    this.topPorts = 8
    this.bottomPorts = 1
  ...
  connectedCallback() {
    ...
    if (this.svg) {
      ...
      this.addComponent('or-gate-eight', this.width / 2 - 30, 82, {
        scale: 0.3,
        'port-scale-outer': 0.2
      })
      // s0 to inverter
      ...
      this.addWire(41, 6, 46.5, 58)
      this.addWire(131, 6, 136.5, 58)
      this.addWire(221, 6, 226.5, 58)
      this.addWire(310, 6, 316.5, 58)
      ...
      this.addWire(88, 12, 92, 58)
      this.addWire(177, 12, 182, 58)
      this.addWire(266, 12, 271, 58)
      this.addWire(355.5, 12, 361, 58)
      // s1 to inverter
      ...
      this.addWire(38, 21, 42, 58)
      this.addWire(86, 18, 87, 58)
      this.addWire(218, 18, 222, 58)
      this.addWire(264, 18, 267, 58)
      ...
      this.addWire(131, 24, 132, 58)
      this.addWire(177, 24, 177, 58)
      this.addWire(310, 24, 312, 58)
      this.addWire(355, 24, 357, 58)
      // s2 to inverter
      ...
      this.addWire(38, 40, 38, 58)
      this.addWire(80, 32, 83, 58)
      this.addWire(125, 32, 128, 58)
      this.addWire(170, 32, 173, 58)
      ...
      this.addWire(216, 40, 217, 58)
      this.addWire(262, 40, 263, 58)
      this.addWire(308, 40, 308, 58)
      this.addWire(353, 40, 352, 58)
      // and gates to or-gate-eight
      for (let i = 0; i < 8; i++) {
        this.addWire(
          this.slotWidth * (i + 1) + i * 0.5,
          72,
          this.width / 2 + (-4 + i) * 6.7 + 4,
          80
        )
      }
    }
...
window.customElements.define('eight-to-one-selector', EightToOneSelector)
